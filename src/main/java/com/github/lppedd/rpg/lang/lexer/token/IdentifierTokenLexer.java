...
public class IdentifierTokenLexer implements TokenLexer {
  private static final Pattern IDENTIFIER_PATTEN =
      Pattern.compile("^ *[a-z][a-z0-9_]*", CASE_INSENSITIVE | UNICODE_CASE);

  private final int startIndex;
  private final int endIndex;

  public IdentifierTokenLexer(final int startIndex, final int endIndex) {
